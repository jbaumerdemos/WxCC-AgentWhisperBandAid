		...
		<style>
				...
				.cards {
					...
					<div class="container">
									...
									<p class="hide"> value: ${this.getWhisperURL()}.mp3</p>
									<iframe src="${this.getWhisperURL()}.mp3" allow="autoplay" style="display:none" id="iframeAudio">
									</iframe> 
									</audio>
					</div>
		`;
